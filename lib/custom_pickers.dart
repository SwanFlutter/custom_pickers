...
import 'package:custom_pickers/src/bottom_sheet.dart';
import 'package:custom_pickers/src/bottom_sheet_image_selector.dart';
import 'package:custom_pickers/src/custom_picker.dart';
import 'package:custom_pickers/src/scaffold_bottom_sheet.dart';
import 'package:custom_pickers/src/tools/media_services.dart';
import 'package:custom_pickers/src/widget/global/camera_image_setting.dart';
...
export 'package:custom_pickers/src/custom_picker.dart';
export 'package:custom_pickers/src/telegram_media_picker.dart';
export 'package:custom_pickers/src/tools/media_services.dart';
export 'package:custom_pickers/src/widget/global/camera_image_setting.dart';
...
///                convertToFileList(); // Convert AssetEntity to files
///           });
/// }),
///
///)
///)
class CustomPickers extends StatefulWidget {
  ...
  /// Constructs a new [CustomPickers] instance with the given properties.
  ///
  ...
  @override
  State<CustomPickers> createState() => _CustomPickersState();

  Future<List<AssetEntity>> instagram(BuildContext context) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CustomPickers(
          maxCount: maxCount,
          requestType: requestType,
...
class _CustomPickersState extends State<CustomPickers>
  ...
  @override
  void didUpdateWidget(covariant CustomPickers oldWidget) {
    _startLoading();
    _loadAlbum();
